      ...
      <div className='rounded-b-lg relative z-20 flex justify-center transition-all duration-500 2xl:pr-14 pt-9'>
        <div>
          <div className='flex gap-6 mb-3'>
            <p className='be-vietnam-pro-regular text-HeadingColor-0 flex gap-2 items-center uppercase'>
          ...
          <Link to={blogUrl}>
            <button className='be-vietnam-pro-regular text-left font-semibold text-xl sm:text-[22px] md:text-[22px] lg:text-xl xl:text-[23px] 2xl:text-[23px] text-HeadingColor-0 transition-all duration-500 hover:text-PrimaryColor-0 mt-2'>
              {blogTitle}
            </button>
          </Link>
        </div>
