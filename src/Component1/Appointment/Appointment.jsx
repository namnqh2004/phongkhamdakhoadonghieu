    ...
    <section className='px-5 2xl:px-20 bg-BodyBg-0 pt-[106px] relative z-10 overflow-hidden'>
      ...
      <div className='bg-[url(/images/appoinment.png)] bg-cover bg-no-repeat bg-center grid grid-cols-1 lg:grid-cols-2 pt-[110px] pb-[118px] lg:border-x-2 2xl:border-x-0 border-white rounded-[30px] relative z-10'>
        ...
        >
          ...
          <h1 className='be-vietnam-pro-extrabold text-HeadingColor-0 text-[16px] leading-[23px] sm:text-[22px] sm:leading-[35px] md:text-[30px] md:leading-[35px] lg:text-[28px] lg:leading-[35px] xl:text-[32px] xl:leading-[39px] 2xl:text-[32px] 2xl:leading-[39px]'>
          ...
          >
            <div className='grid grid-cols-1 sm:grid-cols-2 gap-5'>
              <div className='relative inline-block'>
                <input
                  ...
                  required
                  className='be-vietnam-pro-regular text-HeadingColor-0 placeholder:text-HeadingColor-0 font-light bg-transparent border border-Secondarycolor-0 border-opacity-45 rounded-xl py-2 px-6 h-[60px] w-full focus:outline-PrimaryColor-0'
                />
                <FaUser
                  size={'14'}
            ...
            <textarea
              ...
              className='be-vietnam-pro-regular text-HeadingColor-0 placeholder:text-HeadingColor-0 font-light bg-transparent border border-Secondarycolor-0 border-opacity-45 rounded-2xl py-2 px-6 h-[150px] w-full focus:outline-PrimaryColor-0 resize-none'
            ></textarea>
