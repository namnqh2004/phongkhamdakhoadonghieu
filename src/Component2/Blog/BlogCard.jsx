    ...
    <div className='group transition-all duration-500 rounded-lg bg-transparent'>
      ...
      <div className='rounded-b-lg relative z-20 flex transition-all duration-500 2xl:pr-14 pt-9'>
        <div>
          ...
          <Link to={blogUrl}>
            <button className='be-vietnam-pro-regular font-semibold text-left text-xl sm:text-[22px] md:text-[22px] lg:text-xl xl:text-[23px] 2xl:text-[23px] text-HeadingColor-0 transition-all duration-500 hover:text-PrimaryColor-0 mt-2'>
              {blogTitle}
            </button>
          </Link>
        </div>
