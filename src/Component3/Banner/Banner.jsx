      ...
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-8 lg:py-0 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-6 space-y-4 sm:space-y-8 text-center lg:text-left">
            ...
            <div className="inline-block">
              <span className="inline-flex items-center gap-2 bg-[#e6f7ed] text-[#16a748] text-[12px] sm:text-[13px] font-bold tracking-wider uppercase px-4 py-2 rounded-full border border-emerald-100 shadow-xs">
                ...
                <svg className="w-2.5 h-2.5 text-[#16a748] animate-pulse" fill="currentColor" viewBox="0 0 8 8" xmlns="http://www.w3.org/2000/svg">
            ...
            <h1 className="be-vietnam-pro-extrabold text-3xl sm:text-5xl lg:text-5xl xl:text-[56px] text-[#1a253c] leading-[1.15] tracking-tight">
              ...
              <span className="block text-[#16a748] mt-1 sm:mt-2">Toàn diện – Tận tâm</span>
            </h1>

            {/* Đoạn mô tả ngắn */}
            <p className="text-sm sm:text-base text-gray-500 leading-relaxed max-w-xl mx-auto lg:mx-0">
              Phòng khám Đa khoa Đông Hiếu quy tụ đội ngũ y bác sĩ đầu ngành, mang đến dịch vụ y tế chất lượng cao và sự an tâm tuyệt đối cho khách hàng.
            </p>
            ...
            <div className="grid grid-cols-3 gap-6 pt-8 border-t border-gray-100 max-w-md mx-auto lg:mx-0">
              <div className="text-center lg:text-left">
                ...
                <span className="text-[11px] sm:text-xs text-gray-400 font-bold uppercase tracking-wider mt-1 block">Chuyên khoa</span>
              </div>
              <div className="text-center lg:text-left border-x border-gray-100 px-4">
                <span className="block text-2xl sm:text-3xl font-extrabold text-[#16a748]">
                  ---
                </span>
                <span className="text-[11px] sm:text-xs text-gray-400 font-bold uppercase tracking-wider mt-1 block">Bác sĩ</span>
              </div>
              <div className="text-center lg:text-left">
                <span className="block text-2xl sm:text-3xl font-extrabold text-[#16a748]">
                  24/7
                </span>
                <span className="text-[11px] sm:text-xs text-gray-400 font-bold uppercase tracking-wider mt-1 block">Cấp cứu</span>
              </div>
            </div>
          ...
          <div className="lg:col-span-6 relative flex items-center justify-center w-full min-h-[350px] sm:min-h-[500px]">
            ...
            <div className="absolute bottom-6 left-2 sm:left-4 bg-white p-3 sm:p-4 rounded-2xl shadow-xl flex items-center space-x-3.5 border border-emerald-50 max-w-[220px] sm:max-w-[260px] transform hover:scale-105 transition-transform duration-300">
              <div className="w-10 h-10 sm:w-11 sm:h-11 rounded-xl bg-emerald-50 flex items-center justify-center flex-shrink-0">
                <div className="w-7 h-7 rounded-lg bg-[#e6f7ed] flex items-center justify-center">
                  {/* Inline SVG cho dấu tích kiểm duyệt thành công (thay thế FaCheck) */}
                  <svg className="w-4 h-4 text-[#16a748]" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="3" d="M5 13l4 4L19 7" />
                  </svg>
                </div>
              </div>
              <div className="text-left">
                <h4 className="font-extrabold text-gray-800 text-xs sm:text-sm">Đạt chuẩn bộ y tế</h4>
                <p className="text-[10px] sm:text-xs text-gray-400 font-medium mt-0.5">An toàn & Chuyên nghiệp</p>
              </div>
            </div>
